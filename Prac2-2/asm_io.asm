...
int_format	    db  "%i", 0
hex_format	    db  "%x", 0	; label que se usa en subrutina print_hex
...
segment .text
%endif
	global	read_int, print_int, print_hex, print_string, read_char
...
; subrutina que imprime en formato hexadecimal
print_hex:
	enter 	0, 0
	pusha
	pushf
